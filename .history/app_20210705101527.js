...
class Card {
    constructor(_class, _initialTime) {
        ...
        this.bottomCardNumber = document.querySelector("." + _class + "--bottom--number_2");
        this.cardTitleTop = document.getElementById(_class);
    ...
    updateTimer() {
        this.cardTitleTop.innerHTML = this.actualTime;
        this.cardTitleBottom.innerHTML = this.pastTime
