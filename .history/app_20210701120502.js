...
setInterval(() => {
    ...
    timeDays.innerHTML = sixtyToZero(leftTime.d[0]);
    timeHours.innerHTML = sixtyToZero(leftTime.h[0]);
    timeMinutes.innerHTML = sixtyToZero(leftTime.m[0]);
    timeSeconds.innerHTML = sixtyToZero(leftTime.s[0]);
