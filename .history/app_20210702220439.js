...
class Card {
    constructor(_class, _initialTime) {
        this.cardTop = document.querySelector("." + _class + "--top--number");
        this.cardBottom = document.querySelector("." + _class + "--bottom--number");
    ...
    updateTimer() {
        ...
        this.cardBottom.innerHTML = this.actualTime;
        this.cardTop.innerHTML = this.actualTime;
        console.log(this.cardTitle, this.cardBottom, this.cardTop);
    }
